    ...
    <div className="wrapper">
      ...
      <div className="app">
        <div className="app__left">
          ...
          <div className="app__box">
            <h2>Contrôle</h2>
            <div className="input"><span>Contrôle</span><input type="number" value={controle} onChange={(e) => this.setState({controle: this.check(e.target.value, 40)})}/><span> / 40</span></div>
          </div>
          <div className="app__box">
            <h2>Environnement</h2>
            ...
            <div className="input"><span>Sécurisant</span><input type="number" value={securisant} onChange={(e) => this.setState({securisant: this.check(e.target.value, 15)})}/><span>&nbsp;/&nbsp;15</span></div>
        ...
        <div className="app__right">
          ...
          <div className="app__box">
            <h2>Date</h2>
            <div className="input">{day} / {month} / {year}</div>
          </div>
        </div>
      </div>
    </div>
